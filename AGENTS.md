# Development Rules for Chat Vault Project
...
- `Chat Vault Project` - Your project's name (appears in title and throughout document)
...
This document establishes the rules and procedures for AI-assisted development on the Chat Vault Project. These rules ensure consistent, trackable, and well-documented development practices.
